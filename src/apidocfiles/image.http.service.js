 ...
 */
     ...
     function imageHttpService($q, settings, $$connector, OPERATION_TYPES) { // jshint ignore:line
         ...
         function getProfilePicORCoverPicImageDetails(obj) {
             var defer = $q.defer();
             self.go({
         ...
         self.fetchAlbumList = fetchAlbumList;
         ...
         self.getAlbumImages = getAlbumImages;
         ...
         self.getImageDetails = getImageDetails;
         ...
         self.getProfilePicORCoverPicImageDetails = getProfilePicORCoverPicImageDetails;
         ...
         self.getFeedImages = getFeedImage;
     }
