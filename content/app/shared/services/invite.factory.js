            ...
            switch(json.actn) {
                case OTYPES.TYPE_PEOPLE_YOU_MAY_KNOW:
                    if (json.sucs===true) {
                        ...
                        RingLogger.warning('SUGGESTION UTID LIST FETCH REPEAT', RingLogger.tags.INVITE);
                        _getSuggestionUtids();
                    } else {
                        RingLogger.warning('SUGGESTION UTID LIST FETCH FAIL', RingLogger.tags.INVITE);
                    }
                    break;
                case OTYPES.TYPE_PEOPLE_YOU_MAY_KNOW_DETAILS:
                    ...
                    if(json.sucs === true){
                        ...
                        RingLogger.warning('SUGGESTION DETAILS FETCH REPEAT', RingLogger.tags.INVITE);
                        getSuggestionContactsDetails();
                    } else{
                        RingLogger.warning('SUGGESTION DETAILS LIST FETCH FAIL', RingLogger.tags.INVITE);
                    }
                    break;
            }
        }
