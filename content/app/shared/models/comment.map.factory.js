    ...
    angular
        ...
        .factory("$$commentMap", ['$$stackedMap','settings','$filter','userFactory','Utils','$$stickerMap','$sce',
            function ($$stackedMap,settings,$filter,userFactory,Utils,$$stickerMap,$sce) {
                ...
                RingComment.prototype = {
                            ...
                            updateTime : function(){
                                ...
                                this.vtime = Utils.verbalDate(this.comment.tm);
                            },
                            setHtml : function(){
                                this.html = $sce.trustAsHtml(Utils.parseForLE(this.comment.cmn));
                            },
                            user: function () {
							...
							isDeleteAble : function(target){
									return this._u.isCurrentUser() || (target && target.user().isCurrentUser());
							}
                };
