    ...
    function ChatConnector($rootScope, $q, Auth, ChatUtilsFactory, settings ) {
        ...
        var _logRequest = function(data, type){
            try{
                ...
                RingLogger.debug("{1}({0}, {2})".format(data.packetType, packetName, type.toUpperCase() ), data, RingLogger.tags.CHAT_REQUEST );
            }catch(e){
        ...
        var _init = function(){
            ...
            try{
                ...
                RingLogger.information('Current User Exception ', e, RingLogger.tags.CHAT);
            }
            ...
            try{
                ...
                RingLogger.alert('Chat Woker Exception ', e, RingLogger.tags.CHAT);
        ...
        ChatWorker.addEventListener('message',function(messageEvent){
            ...
            switch (messageEvent.data.notifier){
                ...
                case WORKER_NOTIFIER_TYPES.DEBUG:
                    ...
                    try{
                        RingLogger[messageEvent.data.type].apply(null, messageEvent.data.m);

                    }catch(e){
                        RingLogger.alert('Invalid Worker Log Type', RingLogger.tags.CHAT);
                ...
                case WORKER_NOTIFIER_TYPES.CHAT_REQUEST_RESPONSE:
                    ...
                    if( !!packetId && !!callbackObject ){
                        if( !!response.notify){
                            ...
                            RingLogger.alert('Error : ', response.msg, RingLogger.tags.CHAT);
                            callbackObject.fn.resolve.call(callbackObject.ctx, response);
