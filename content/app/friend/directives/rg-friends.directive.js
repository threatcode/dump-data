                ...
                if (mutualFriends.length > 0) {
                    ...
                    friendsFactory.getContactDetailsByUtIds(mutualFriends.splice(0, 10), true).then(function(json) {
                        ...
                        if (json.sucs === false && json.rc === 1111) {
                            RingLogger.warning('MUTUAL FRIEND FETCH REPEAT', RingLogger.tags.FRIEND);
                            loadMutualFriends();
                        } else {
                            toggleLoading(false);
                            RingLogger.warning('MUTUAL FRIEND FETCH FAILED', RingLogger.tags.FRIEND);
                        }
                    });
                }
            }
                ...
                if ($scope.showMutual) {
                    ...
                    whatToCall(param).then(function() {
                        ...
                        if (json.sucs === false && json.rc === 1111) {
                            ...
                            toggleLoading(false);
                            RingLogger.alert('friend Details fetch fail, RETRYING', RingLogger.tags.FRIEND);
