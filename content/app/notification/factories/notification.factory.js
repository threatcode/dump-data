                ...
                switch(json.actn) {
                    case OTYPES.TYPE_MY_NOTIFICATIONS:
                        if (json.sucs === true || json.sucs === 'true' ) {
                            ...
                            RingLogger.information('CURRENT oldNotiCount=' + oldNotiCount + ' totalNewNoti=' + json.tn, RingLogger.tags.NOTIFICATION);
                            ...
                            RingLogger.information('MODIFIED notiCounter=' + notiCounter, RingLogger.tags.NOTIFICATION);
                            ...
                            RingLogger.warning('Notification list request REPEAT', RingLogger.tags.NOTIFICATION);
                            loadMoreNoti();
                        } else {
			...
			return {
				...
				clearCounter: function() {
                    if (notiCounter > 0)  {
                        ...
                        RingLogger.information('Setting oldNotiCount in localStorage=' + Storage.getData('oldNotiCount'), RingLogger.tags.NOTIFICATION);
                        notiCounter = 0;
