	...
	}), angular.module("angular-svg-round-progress").service("roundProgressService", [
	    function() {
	        var a = {},
	            b = angular.isNumber;
	        ...
	        return a.toNumber = function(a) {
	            ...
	            var h = a >= b ? b - 1e-5 : a,
	                ...
	                m = c(k, k, d, 0),
	                n = 180 >= j ? "0" : "1",
	                o = ["M", l.x, l.y, "A", d, d, 0, n, 0, m.x, m.y].join(" ");
	            return e.attr("d", o)
	        }, a.animations = {
	...
	]), angular.module("angular-svg-round-progress").directive("roundProgress", ["$window", "roundProgressService", "roundProgressConfig",
	    function(a, b, c) {
	        var d = {
	            restrict: "EA",
	            replace: !0,
	        ...
	        return b.isSupported ? angular.extend(d, {
	            ...
	            link: function(d, e) {
	                var f, g = angular.element(e[0].querySelector("svg")),
	                    h = g.find("path"),
	                    i = g.find("circle"),
	                    j = angular.copy(c),
	                    k = function() {
	                        ...
	                        g.css({
	                            ...
	                            stroke: j.color,
	                            "stroke-width": d,
	                            "stroke-linecap": j.rounded ? "round" : "butt"
	                        }), a ? h.attr("transform", j.clockwise ? "translate(0," + f + ") rotate(-90)" : "translate(" + f + ", " + f + ") rotate(90) scale(-1, 1)") : h.attr("transform", j.clockwise ? "" : "scale(-1, 1) translate(" + -f + " 0)"), i.attr({
	                            cx: c,
	                            cy: c,
	                            r: k >= 0 ? k : 0
	                        }).css({
	                    ...
	                    l = function(c, d) {
	                        var e = b.toNumber(j.max || 0),
	                            g = c > e ? e : 0 > c || !c ? 0 : c,
	                            i = d === g || 0 > d ? 0 : d || 0,
	                            k = g - i,
	                            l = b.animations[j.animation],
	                            m = new Date,
	                            n = parseInt(j.duration),
	                            o = j.radius,
	                            p = o - j.stroke / 2,
	                            q = 2 * o;
	                        a.cancelAnimationFrame(f), n > 25 ? ! function r() {
	                            var c = new Date - m;
	                            b.updateState(l(c, i, k, n), e, p, h, q, j.semi), n > c && (f = a.requestAnimationFrame(r))
	                        }() : b.updateState(g, e, p, h, q, j.semi)
	                    };
	                d.$watchCollection("[current, max, semi, rounded, clockwise, radius, color, bgcolor, stroke, duration, responsive]", function(a, c, d) {
	                    angular.forEach(d, function(a, b) {
	                        b.indexOf("$") && d !== a && angular.isDefined(a) && (j[b] = a)
	                    }), k(), l(b.toNumber(a[0]), b.toNumber(c[0]))
	                })
	            },
