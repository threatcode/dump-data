 ...
 */
	...
	angular
        ...
        socialPopup.$inject = ['$$q', '$interval', '$window', 'socialConfig', 'socialUtils'];
        function socialPopup ($q, $interval, $window, socialConfig, socialUtils) { // jshint ignore:line
            var Popup = {};
            ...
            Popup.prepareOptions = function(options) {
                options = options || {};
                //var width = (Utils.viewport.y - 600) || options.width || 500;
                //var height = (Utils.viewport.x - 300) || options.height || 500;
