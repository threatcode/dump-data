...
function notificationHttpService($$connector, settings, OPERATION_TYPES) {
    var self = this,
    ...
    function getImageAlbumDetails(obj) {
        var payload = {
            actn: OPERATION_TYPES.SYSTEM.TYPE_SINGLE_STATUS_NOTIFICATION_OR_SHARE_DETAILS,
    ...
    self.clearNotiCount = clearNotiCount;

    self.getNotificationDetails = getNotificationDetails;

    self.getImageAlbumDetails = getImageAlbumDetails;
}
