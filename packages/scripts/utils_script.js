...
var emoticons_map = {
  '(evil-grin_l)': {
    id: 0,
    name: 'evil-grin_l.png',
    symbol: '(evil-grin_l)',
    url: 'http://' + icon_server + '/emoticon/evil-grin_l.png',
    type: 1,
  },
  '(cheeky_l)': {
    id: 0,
    name: 'cheeky_l.png',
    symbol: '(cheeky_l)',
    url: 'http://' + icon_server + '/emoticon/cheeky_l.png',
    type: 1,
  },
  ':x': {
    id: 0,
    name: 'my-lips-are-sealed.png',
    symbol: ':x',
    url: 'http://' + icon_server + '/emoticon/my-lips-are-sealed.png',
    type: 0,
  },
  '(wasntme)': {
    id: 0,
    name: 'it-wasn-me.png',
    symbol: '(wasntme)',
    url: 'http://' + icon_server + '/emoticon/it-wasn-me.png',
    type: 0,
  },
  '(kiss_l)': {
    id: 0,
    name: 'kiss_l.png',
    symbol: '(kiss_l)',
    url: 'http://' + icon_server + '/emoticon/kiss_l.png',
    type: 1,
  },
  '(dull_l)': {
    id: 0,
    name: 'dull_l.png',
    symbol: '(dull_l)',
    url: 'http://' + icon_server + '/emoticon/dull_l.png',
    type: 1,
  },
  '(inti)': {
    id: 0,
    name: 'be-intimidated.png',
    symbol: '(inti)',
    url: 'http://' + icon_server + '/emoticon/be-intimidated.png',
    type: 0,
  },
  ':l': {
    id: 0,
    name: 'speechless.png',
    symbol: ':l',
    url: 'http://' + icon_server + '/emoticon/speechless.png',
    type: 0,
  },
  '(shake)': {
    id: 0,
    name: 'shake.png',
    symbol: '(shake)',
    url: 'http://' + icon_server + '/emoticon/shake.png',
    type: 0,
  },
  '(phantom)': {
    id: 0,
    name: 'phantom.png',
    symbol: '(phantom)',
    url: 'http://' + icon_server + '/emoticon/phantom.png',
    type: 0,
  },
  '(unex)': {
    id: 0,
    name: 'unexpected-smiles.png',
    symbol: '(unex)',
    url: 'http://' + icon_server + '/emoticon/unexpected-smiles.png',
    type: 0,
  },
  '(arrowhead_l)': {
    id: 0,
    name: 'arrowhead_l.png',
    symbol: '(arrowhead_l)',
    url: 'http://' + icon_server + '/emoticon/arrowhead_l.png',
    type: 1,
  },
  '(party)': {
    id: 0,
    name: 'party.png',
    symbol: '(party)',
    url: 'http://' + icon_server + '/emoticon/party.png',
    type: 0,
  },
  '(in_love_l)': {
    id: 0,
    name: 'in_love_l.png',
    symbol: '(in_love_l)',
    url: 'http://' + icon_server + '/emoticon/in_love_l.png',
    type: 1,
  },
  '(an-happy)': {
    id: 0,
    name: 'more-than-happy.png',
    symbol: '(an-happy)',
    url: 'http://' + icon_server + '/emoticon/more-than-happy.png',
    type: 0,
  },
  '(shake_l)': {
    id: 0,
    name: 'shake_l.png',
    symbol: '(shake_l)',
    url: 'http://' + icon_server + '/emoticon/shake_l.png',
    type: 1,
  },
  '(startle_l)': {
    id: 0,
    name: 'startle_l.png',
    symbol: '(startle_l)',
    url: 'http://' + icon_server + '/emoticon/startle_l.png',
    type: 1,
  },
  '(my_lips_are_sealed_l)': {
    id: 0,
    name: 'my_lips_are_sealed_l.png',
    symbol: '(my_lips_are_sealed_l)',
    url: 'http://' + icon_server + '/emoticon/my_lips_are_sealed_l.png',
    type: 1,
  },
  '(shouting_l)': {
    id: 0,
    name: 'shouting_l.png',
    symbol: '(shouting_l)',
    url: 'http://' + icon_server + '/emoticon/shouting_l.png',
    type: 1,
  },
  '(showing_his_muscular_arm_l)': {
    id: 0,
    name: 'showing_his_muscular_arm_l.png',
    symbol: '(showing_his_muscular_arm_l)',
    url: 'http://' + icon_server + '/emoticon/showing_his_muscular_arm_l.png',
    type: 1,
  },
  '(yawn)': {
    id: 0,
    name: 'yawn.png',
    symbol: '(yawn)',
    url: 'http://' + icon_server + '/emoticon/yawn.png',
    type: 0,
  },
  '(wait)': {
    id: 0,
    name: 'wait.png',
    symbol: '(wait)',
    url: 'http://' + icon_server + '/emoticon/wait.png',
    type: 0,
  },
  '(happy_birthday_l)': {
    id: 0,
    name: 'happy_birthday_l.png',
    symbol: '(happy_birthday_l)',
    url: 'http://' + icon_server + '/emoticon/happy_birthday_l.png',
    type: 1,
  },
  ':P': {
    id: 0,
    name: 'cheeky.png',
    symbol: ':P',
    url: 'http://' + icon_server + '/emoticon/cheeky.png',
    type: 0,
  },
  ':O': {
    id: 0,
    name: 'surprised.png',
    symbol: ':O',
    url: 'http://' + icon_server + '/emoticon/surprised.png',
    type: 0,
  },
  '(regretted-borne-crying)': {
    id: 0,
    name: 'regretted-borne-crying.png',
    symbol: '(regretted-borne-crying)',
    url: 'http://' + icon_server + '/emoticon/regretted-borne-crying.png',
    type: 0,
  },
  ':D': {
    id: 0,
    name: 'laugh.png',
    symbol: ':D',
    url: 'http://' + icon_server + '/emoticon/laugh.png',
    type: 0,
  },
  '(terrible_smile_l)': {
    id: 0,
    name: 'terrible_smile_l.png',
    symbol: '(terrible_smile_l)',
    url: 'http://' + icon_server + '/emoticon/terrible_smile_l.png',
    type: 1,
  },
  '(blushing_l)': {
    id: 0,
    name: 'blushing_l.png',
    symbol: '(blushing_l)',
    url: 'http://' + icon_server + '/emoticon/blushing_l.png',
    type: 1,
  },
  '(devil_l)': {
    id: 0,
    name: 'devil_l.png',
    symbol: '(devil_l)',
    url: 'http://' + icon_server + '/emoticon/devil_l.png',
    type: 1,
  },
  ';)': {
    id: 0,
    name: 'wink.png',
    symbol: ';)',
    url: 'http://' + icon_server + '/emoticon/wink.png',
    type: 0,
  },
  '(presentation)': {
    id: 0,
    ...
    symbol: '(presentation)',
    url: 'http://' + icon_server + '/emoticon/presentation.png',
    type: 0,
  },
  '(dreams_of_love_l)': {
    id: 0,
    name: 'dreams_of_love_l.png',
    symbol: '(dreams_of_love_l)',
    url: 'http://' + icon_server + '/emoticon/dreams_of_love_l.png',
    type: 1,
  },
  ';(': {
    id: 0,
    name: 'crying.png',
    symbol: ';(',
    url: 'http://' + icon_server + '/emoticon/crying.png',
    type: 0,
  },
  '(facepalm)': {
    id: 0,
    name: 'facepalm.png',
    symbol: '(facepalm)',
    url: 'http://' + icon_server + '/emoticon/facepalm.png',
    type: 0,
  },
  '(trouble)': {
    id: 0,
    name: 'goofy-feeling-trouble.png',
    symbol: '(trouble)',
    url: 'http://' + icon_server + '/emoticon/goofy-feeling-trouble.png',
    type: 0,
  },
  '(furious_l)': {
    id: 0,
    name: 'furious_l.png',
    symbol: '(furious_l)',
    url: 'http://' + icon_server + '/emoticon/furious_l.png',
    type: 1,
  },
  '(women_fish_l)': {
    id: 0,
    name: 'women_fish_l.png',
    symbol: '(women_fish_l)',
    url: 'http://' + icon_server + '/emoticon/women_fish_l.png',
    type: 1,
  },
  '(:': {
    id: 0,
    name: 'sweating.png',
    symbol: '(:',
    url: 'http://' + icon_server + '/emoticon/sweating.png',
    type: 0,
  },
  '(yawn_l)': {
    id: 0,
    name: 'yawn_l.png',
    symbol: '(yawn_l)',
    url: 'http://' + icon_server + '/emoticon/yawn_l.png',
    type: 1,
  },
  '(cool)': {
    id: 0,
    name: 'cool.png',
    symbol: '(cool)',
    url: 'http://' + icon_server + '/emoticon/cool.png',
    type: 0,
  },
  '(facepalm_l)': {
    id: 0,
    name: 'facepalm_l.png',
    symbol: '(facepalm_l)',
    url: 'http://' + icon_server + '/emoticon/facepalm_l.png',
    type: 1,
  },
  ':*': {
    id: 0,
    name: 'kiss.png',
    symbol: ':*',
    url: 'http://' + icon_server + '/emoticon/kiss.png',
    type: 0,
  },
  '(nurses_l)': {
    id: 0,
    name: 'nurses_l.png',
    symbol: '(nurses_l)',
    url: 'http://' + icon_server + '/emoticon/nurses_l.png',
    type: 1,
  },
  ':(': {
    id: 0,
    name: 'sad.png',
    symbol: ':(',
    url: 'http://' + icon_server + '/emoticon/sad.png',
    type: 0,
  },
  ':)': {
    id: 0,
    name: 'smile.png',
    symbol: ':)',
    url: 'http://' + icon_server + '/emoticon/smile.png',
    type: 0,
  },
  '(re-sad)': {
    id: 0,
    name: 're-sad.png',
    symbol: '(re-sad)',
    url: 'http://' + icon_server + '/emoticon/re-sad.png',
    type: 0,
  },
  ':$': {
    id: 0,
    name: 'blushing.png',
    symbol: ':$',
    url: 'http://' + icon_server + '/emoticon/blushing.png',
    type: 0,
  },
  '(in-love)': {
    id: 0,
    name: 'in-love.png',
    symbol: '(in-love)',
    url: 'http://' + icon_server + '/emoticon/in-love.png',
    type: 0,
  },
  '(hi_l)': {
    id: 0,
    name: 'hi_l.png',
    symbol: '(hi_l)',
    url: 'http://' + icon_server + '/emoticon/hi_l.png',
    type: 1,
  },
  '(worry)': {
    id: 0,
    name: 'worried.png',
    symbol: '(worry)',
    url: 'http://' + icon_server + '/emoticon/worried.png',
    type: 0,
  },
  '(reading_a_newspaper_l)': {
    id: 0,
    name: 'reading_a_newspaper_l.png',
    symbol: '(reading_a_newspaper_l)',
    url: 'http://' + icon_server + '/emoticon/reading_a_newspaper_l.png',
    type: 1,
  },
  '(cartoon_alarm_clock_l)': {
    id: 0,
    name: 'cartoon_alarm_clock_l.png',
    symbol: '(cartoon_alarm_clock_l)',
    url: 'http://' + icon_server + '/emoticon/cartoon_alarm_clock_l.png',
    type: 1,
  },
  ' (shame)': {
    id: 0,
    name: 'shame.png',
    symbol: ' (shame)',
    url: 'http://' + icon_server + '/emoticon/shame.png',
    type: 0,
  },
  '(unpleasantness_l)': {
    id: 0,
    name: 'unpleasantness_l.png',
    symbol: '(unpleasantness_l)',
    url: 'http://' + icon_server + '/emoticon/unpleasantness_l.png',
    type: 1,
  },
  '(surprised_l)': {
    id: 0,
    name: 'surprised_l.png',
    symbol: '(surprised_l)',
    url: 'http://' + icon_server + '/emoticon/surprised_l.png',
    type: 1,
  },
  '(cool_l)': {
    id: 0,
    name: 'cool_l.png',
    symbol: '(cool_l)',
    url: 'http://' + icon_server + '/emoticon/cool_l.png',
    type: 1,
  },
  '(puking_l)': {
    id: 0,
    name: 'puking_l.png',
    symbol: '(puking_l)',
    url: 'http://' + icon_server + '/emoticon/puking_l.png',
    type: 1,
  },
  '(speechless_l)': {
    id: 0,
    name: 'speechless_l.png',
    symbol: '(speechless_l)',
    url: 'http://' + icon_server + '/emoticon/speechless_l.png',
    type: 1,
  },
  '(e-smile)': {
    id: 0,
    name: 'terrible-smile.png',
    symbol: '(e-smile)',
    url: 'http://' + icon_server + '/emoticon/terrible-smile.png',
    type: 0,
  },
  '(contract)': {
    id: 0,
    name: 'phone-contract.png',
    symbol: '(contract)',
    url: 'http://' + icon_server + '/emoticon/phone-contract.png',
    type: 0,
  },
  '(angry_l)': {
    id: 0,
    name: 'angry_l.png',
    symbol: '(angry_l)',
    url: 'http://' + icon_server + '/emoticon/angry_l.png',
    type: 1,
  },
  '(holding_a_scepter_l)': {
    id: 0,
    name: 'holding_a_scepter_l.png',
    symbol: '(holding_a_scepter_l)',
    url: 'http://' + icon_server + '/emoticon/holding_a_scepter_l.png',
    type: 1,
  },
  '(with_headphones_l)': {
    id: 0,
    name: 'with_headphones_l.png',
    symbol: '(with_headphones_l)',
    url: 'http://' + icon_server + '/emoticon/with_headphones_l.png',
    type: 1,
  },
  '(angry)': {
    id: 0,
    name: 'angry.png',
    symbol: '(angry)',
    url: 'http://' + icon_server + '/emoticon/angry.png',
    type: 0,
  },
  '(goofy_feeling_trouble_l)': {
    id: 0,
    name: 'goofy_feeling_trouble_l.png',
    symbol: '(goofy_feeling_trouble_l)',
    url: 'http://' + icon_server + '/emoticon/goofy_feeling_trouble_l.png',
    type: 1,
  },
  '(envy_l)': {
    id: 0,
    name: 'envy_l.png',
    symbol: '(envy_l)',
    url: 'http://' + icon_server + '/emoticon/envy_l.png',
    type: 1,
  },
  '(unexpected_smiles_l)': {
    id: 0,
    name: 'unexpected_smiles_l.png',
    symbol: '(unexpected_smiles_l)',
    url: 'http://' + icon_server + '/emoticon/unexpected_smiles_l.png',
    type: 1,
  },
  '(topics_over_l)': {
    id: 0,
    name: 'topics_over_l.png',
    symbol: '(topics_over_l)',
    url: 'http://' + icon_server + '/emoticon/topics_over_l.png',
    type: 1,
  },
  '(cat-hat)': {
    id: 0,
    name: 'cat-hat.png',
    symbol: '(cat-hat)',
    url: 'http://' + icon_server + '/emoticon/cat-hat.png',
    type: 0,
  },
  '(it_wasn_me_l)': {
    id: 0,
    name: 'it_wasn_me_l.png',
    symbol: '(it_wasn_me_l)',
    url: 'http://' + icon_server + '/emoticon/it_wasn_me_l.png',
    type: 1,
  },
  '(head_hot_l)': {
    id: 0,
    name: 'head_hot_l.png',
    symbol: '(head_hot_l)',
    url: 'http://' + icon_server + '/emoticon/head_hot_l.png',
    type: 1,
  },
  '(forgotten)': {
    id: 0,
    name: 'forgotten.png',
    symbol: '(forgotten)',
    url: 'http://' + icon_server + '/emoticon/forgotten.png',
    type: 0,
  },
  '(fingers_crossed_l)': {
    id: 0,
    name: 'fingers_crossed_l.png',
    symbol: '(fingers_crossed_l)',
    url: 'http://' + icon_server + '/emoticon/fingers_crossed_l.png',
    type: 1,
  },
  '(look_nice_l)': {
    id: 0,
    name: 'look_nice_l.png',
    symbol: '(look_nice_l)',
    url: 'http://' + icon_server + '/emoticon/look_nice_l.png',
    type: 1,
  },
  '(devil)': {
    id: 0,
    name: 'devil.png',
    symbol: '(devil)',
    url: 'http://' + icon_server + '/emoticon/devil.png',
    type: 0,
  },
  '(wondering_l)': {
    id: 0,
    name: 'wondering_l',
    symbol: '(wondering_l)',
    url: 'http://' + icon_server + '/emoticon/wondering_l',
    type: 1,
  },
  '(evil-grin)': {
    id: 0,
    name: 'evil-grin.png',
    symbol: '(evil-grin)',
    url: 'http://' + icon_server + '/emoticon/evil-grin.png',
    type: 0,
  },
  '(nurses)': {
    id: 0,
    name: 'nurses.png',
    symbol: '(nurses)',
    url: 'http://' + icon_server + '/emoticon/nurses.png',
    type: 0,
  },
  '(presentation_l)': {
    id: 0,
    name: 'presentation_l.png',
    symbol: '(presentation_l)',
    url: 'http://' + icon_server + '/emoticon/presentation_l.png',
    type: 1,
  },
  '(head-hot)': {
    id: 0,
    name: 'head-hot.png',
    symbol: '(head-hot)',
    url: 'http://' + icon_server + '/emoticon/head-hot.png',
    type: 0,
  },
  '(funny_cow_l)': {
    id: 0,
    name: 'funny_cow_l.png',
    symbol: '(funny_cow_l)',
    url: 'http://' + icon_server + '/emoticon/funny_cow_l.png',
    type: 1,
  },
  '(nerdy_l)': {
    id: 0,
    name: 'nerdy_l.png',
    symbol: '(nerdy_l)',
    url: 'http://' + icon_server + '/emoticon/nerdy_l.png',
    type: 1,
  },
  '(laugh_l)': {
    id: 0,
    name: 'laugh_l.png',
    symbol: '(laugh_l)',
    url: 'http://' + icon_server + '/emoticon/laugh_l.png',
    type: 1,
  },
  '(minus)': {
    id: 0,
    name: 'minus-points.png',
    symbol: '(minus)',
    url: 'http://' + icon_server + '/emoticon/minus-points.png',
    type: 0,
  },
  '(crying_l)': {
    id: 0,
    name: 'crying_l.png',
    symbol: '(crying_l)',
    url: 'http://' + icon_server + '/emoticon/crying_l.png',
    type: 1,
  },
  '(sad_l)': {
    id: 0,
    name: 'sad_l.png',
    symbol: '(sad_l)',
    url: 'http://' + icon_server + '/emoticon/sad_l.png',
    type: 1,
  },
  '(tness)': {
    id: 0,
    name: 'unpleasantness.png',
    symbol: '(tness)',
    url: 'http://' + icon_server + '/emoticon/unpleasantness.png',
    type: 0,
  },
  '(wave)': {
    id: 0,
    name: 'hi.png',
    symbol: '(wave)',
    url: 'http://' + icon_server + '/emoticon/hi.png',
    type: 0,
  },
  '(scorpions_l)': {
    id: 0,
    name: 'scorpions_l.png',
    symbol: '(scorpions_l)',
    url: 'http://' + icon_server + '/emoticon/scorpions_l.png',
    type: 1,
  },
  '(minus_points_l)': {
    id: 0,
    name: 'minus_points_l.png',
    symbol: '(minus_points_l)',
    url: 'http://' + icon_server + '/emoticon/minus_points_l.png',
    type: 1,
  },
  '(shame_l)': {
    id: 0,
    name: 'shame_l.png',
    symbol: '(shame_l)',
    url: 'http://' + icon_server + '/emoticon/shame_l.png',
    type: 1,
  },
  '(dap)': {
    id: 0,
    name: 'clapping.png',
    symbol: '(dap)',
    url: 'http://' + icon_server + '/emoticon/clapping.png',
    type: 0,
  },
  '(doctor_stethoscope_l)': {
    id: 0,
    name: 'doctor_stethoscope_l.png',
    symbol: '(doctor_stethoscope_l)',
    url: 'http://' + icon_server + '/emoticon/doctor_stethoscope_l.png',
    type: 1,
  },
  '(forgotten_l)': {
    id: 0,
    name: 'forgotten_l.png',
    symbol: '(forgotten_l)',
    url: 'http://' + icon_server + '/emoticon/forgotten_l.png',
    type: 1,
  },
  '(puke)': {
    id: 0,
    name: 'puking.png',
    symbol: '(puke)',
    url: 'http://' + icon_server + '/emoticon/puking.png',
    type: 0,
  },
  '(be_intimidated_l)': {
    id: 0,
    name: 'be_intimidated_l.png',
    symbol: '(be_intimidated_l)',
    url: 'http://' + icon_server + '/emoticon/be_intimidated_l.png',
    type: 1,
  },
  '(flashed_smiles_l)': {
    id: 0,
    name: 'flashed_smiles_l.png',
    symbol: '(flashed_smiles_l)',
    url: 'http://' + icon_server + '/emoticon/flashed_smiles_l.png',
    type: 1,
  },
  '(amour)': {
    id: 0,
    name: 'amour-dreams.png',
    symbol: '(amour)',
    url: 'http://' + icon_server + '/emoticon/amour-dreams.png',
    type: 0,
  },
  '(creative-man)': {
    id: 0,
    name: 'creative-man.png',
    symbol: '(creative-man)',
    url: 'http://' + icon_server + '/emoticon/creative-man.png',
    type: 0,
  },
  '(creative_man_l)': {
    id: 0,
    name: 'creative_man_l.png',
    symbol: '(creative_man_l)',
    url: 'http://' + icon_server + '/emoticon/creative_man_l.png',
    type: 1,
  },
  '(nerd)': {
    id: 0,
    name: 'nerdy.png',
    symbol: '(nerd)',
    url: 'http://' + icon_server + '/emoticon/nerdy.png',
    type: 0,
  },
  '(sweating_l)': {
    id: 0,
    name: 'sweating_l.png',
    symbol: '(sweating_l)',
    url: 'http://' + icon_server + '/emoticon/sweating_l.png',
    type: 1,
  },
  '(panic_l)': {
    id: 0,
    name: 'panic_l.png',
    symbol: '(panic_l)',
    url: 'http://' + icon_server + '/emoticon/panic_l.png',
    type: 1,
  },
  '(clapping_l)': {
    id: 0,
    name: 'clapping_l.png',
    symbol: '(clapping_l)',
    url: 'http://' + icon_server + '/emoticon/clapping_l.png',
    type: 1,
  },
  '(angel_l)': {
    id: 0,
    name: 'angel_l.png',
    symbol: '(angel_l)',
    url: 'http://' + icon_server + '/emoticon/angel_l.png',
    type: 1,
  },
  '(doh_l)': {
    id: 0,
    name: 'doh_l.png',
    symbol: '(doh_l)',
    url: 'http://' + icon_server + '/emoticon/doh_l.png',
    type: 1,
  },
  '(run_l)': {
    id: 0,
    name: 'run_l.png',
    symbol: '(run_l)',
    url: 'http://' + icon_server + '/emoticon/run_l.png',
    type: 1,
  },
  '(over)': {
    id: 0,
    name: 'topics-over.png',
    symbol: '(over)',
    url: 'http://' + icon_server + '/emoticon/topics-over.png',
    type: 0,
  },
  '|-(': {
    id: 0,
    name: 'dull.png',
    symbol: '|-(',
    url: 'http://' + icon_server + '/emoticon/dull.png',
    type: 0,
  },
  ':^)': {
    id: 0,
    name: 'wondering.png',
    symbol: ':^)',
    url: 'http://' + icon_server + '/emoticon/wondering.png',
    type: 0,
  },
  '(baby_elephant_l)': {
    id: 0,
    name: 'baby_elephant_l.png',
    symbol: '(baby_elephant_l)',
    url: 'http://' + icon_server + '/emoticon/baby_elephant_l.png',
    type: 1,
  },
  '(exhausted_l)': {
    id: 0,
    name: 'exhausted_l.png',
    symbol: '(exhausted_l)',
    url: 'http://' + icon_server + '/emoticon/exhausted_l.png',
    type: 1,
  },
  '(more_than_happy_l)': {
    id: 0,
    name: 'more_than_happy_l.png',
    symbol: '(more_than_happy_l)',
    url: 'http://' + icon_server + '/emoticon/more_than_happy_l.png',
    type: 1,
  },
  '(sleepy_l)': {
    id: 0,
    name: 'sleepy_l.png',
    symbol: '(sleepy_l)',
    url: 'http://' + icon_server + '/emoticon/sleepy_l.png',
    type: 1,
  },
  '|-)': {
    id: 0,
    name: 'sleepy.png',
    symbol: '|-)',
    url: 'http://' + icon_server + '/emoticon/sleepy.png',
    type: 0,
  },
  '(angel)': {
    id: 0,
    name: 'angel.png',
    symbol: '(angel)',
    url: 'http://' + icon_server + '/emoticon/angel.png',
    type: 0,
  },
  '(wink_l)': {
    id: 0,
    name: 'wink_l.png',
    symbol: '(wink_l)',
    url: 'http://' + icon_server + '/emoticon/wink_l.png',
    type: 1,
  },
  '(regretted_borne_crying_l)': {
    id: 0,
    name: 'regretted_borne_crying_l.png',
    symbol: '(regretted_borne_crying_l)',
    url: 'http://' + icon_server + '/emoticon/regretted_borne_crying_l.png',
    type: 1,
  },
  '(pointing_an_accusing_finger_l)': {
    id: 0,
    name: 'pointing_an_accusing_finger_l.png',
    symbol: '(pointing_an_accusing_finger_l)',
    url:
      'http://' + icon_server + '/emoticon/pointing_an_accusing_finger_l.png',
    type: 1,
  },
  '(nice)': {
    id: 0,
    name: 'look-nice.png',
    symbol: '(nice)',
    url: 'http://' + icon_server + '/emoticon/look-nice.png',
    type: 0,
  },
  '(rofl)': {
    id: 0,
    name: 'rolling-on.png',
    symbol: '(rofl)',
    url: 'http://' + icon_server + '/emoticon/rolling-on.png',
    type: 0,
  },
  '(doh)': {
    id: 0,
    name: 'doh.png',
    symbol: '(doh)',
    url: 'http://' + icon_server + '/emoticon/doh.png',
    type: 0,
  },
  '(phone_contract_l)': {
    id: 0,
    name: 'phone_contract_l.png',
    symbol: '(phone_contract_l)',
    url: 'http://' + icon_server + '/emoticon/phone_contract_l.png',
    type: 1,
  },
  '(amour_dreams_l)': {
    id: 0,
    name: 'amour_dreams_l.png',
    symbol: '(amour_dreams_l)',
    url: 'http://' + icon_server + '/emoticon/amour_dreams_l.png',
    type: 1,
  },
  '(wait_l)': {
    id: 0,
    name: 'wait_l.png',
    symbol: '(wait_l)',
    url: 'http://' + icon_server + '/emoticon/wait_l.png',
    type: 1,
  },
  '(phantom_l)': {
    id: 0,
    name: 'phantom_l.png',
    symbol: '(phantom_l)',
    url: 'http://' + icon_server + '/emoticon/phantom_l.png',
    type: 1,
  },
  '(worried_l)': {
    id: 0,
    name: 'worried_l.png',
    symbol: '(worried_l)',
    url: 'http://' + icon_server + '/emoticon/worried_l.png',
    type: 1,
  },
  '(sta)': {
    id: 0,
    name: 'startle.png',
    symbol: '(sta)',
    url: 'http://' + icon_server + '/emoticon/startle.png',
    type: 0,
  },
  '(ms-of)': {
    id: 0,
    name: 'dreams-of-love.png',
    symbol: '(ms-of)',
    url: 'http://' + icon_server + '/emoticon/dreams-of-love.png',
    type: 0,
  },
  '(rolling_on_l)': {
    id: 0,
    name: 'rolling_on_l.png',
    symbol: '(rolling_on_l)',
    url: 'http://' + icon_server + '/emoticon/rolling_on_l.png',
    type: 1,
  },
  '(cat_hat_l)': {
    id: 0,
    name: 'cat_hat_l.png',
    symbol: '(cat_hat_l)',
    url: 'http://' + icon_server + '/emoticon/cat_hat_l.png',
    type: 1,
  },
  '(smile_l)': {
    id: 0,
    name: 'smile_l.png',
    symbol: '(smile_l)',
    url: 'http://' + icon_server + '/emoticon/smile_l.png',
    type: 1,
  },
  '(flashed)': {
    id: 0,
    name: 'flashed-smiles.png',
    symbol: '(flashed)',
    url: 'http://' + icon_server + '/emoticon/flashed-smiles.png',
    type: 0,
  },
  '(yn)': {
    id: 0,
    name: 'fingers-crossed.png',
    symbol: '(yn)',
    url: 'http://' + icon_server + '/emoticon/fingers-crossed.png',
    type: 0,
  },
  '(envy)': {
    id: 0,
    name: 'envy.png',
    symbol: '(envy)',
    url: 'http://' + icon_server + '/emoticon/envy.png',
    type: 0,
  },
  '(re_sad_l)': {
    id: 0,
    name: 're_sad_l.png',
    symbol: '(re_sad_l)',
    url: 'http://' + icon_server + '/emoticon/re_sad_l.png',
    type: 1,
  },
  '(zipping_his_mouth_l)': {
    id: 0,
    name: 'zipping_his_mouth_l.png',
    symbol: '(zipping_his_mouth_l)',
    url: 'http://' + icon_server + '/emoticon/zipping_his_mouth_l.png',
    type: 1,
  },
  '(party_l)': {
    id: 0,
    name: 'party_l.png',
    symbol: '(party_l)',
    url: 'http://' + icon_server + '/emoticon/party_l.png',
    type: 1,
  },
  '(clown_face_l)': {
    id: 0,
    name: 'clown_face_l.png',
    symbol: '(clown_face_l)',
    url: 'http://' + icon_server + '/emoticon/clown_face_l.png',
    type: 1,
  },
};
...
var utils = {
  ...
  alert: function (ob, type, target) {
    // ob is message object contain title and message as ob.t and ob.m  , type is success,warnning,info, target is target element to palce the error
  ...
  prepareNameWithLink: function (fn, ln, id) {
    ...
    if (userIdentity === id) {
      username =
        "<a href='" +
        base_url +
        "/secure/user/profile/myid.xhtml'>" +
        userName +
        '</a>  ';
    } else {
      username =
        "<a href='" +
        base_url +
        '/secure/user/friend/profile.xhtml?friend=' +
        id +
        "' >" +
        userName +
        '</a>  ';
  ...
  getImageWithSize: function (size, imageUrl) {
    ...
    var output = [
      imageUrl.slice(0, position),
      size,
      imageUrl.slice(position),
    ].join('');
    return output;
  },
  ...
  agent_notification_1: function (jsonData) {
    ...
    if (jsonData.sucs) {
      ...
      for (var i = 0; i < jData.length; i++) {
        ...
        if (v_li_array_list.length > 0) {
          v_content =
            ...
            json.acId +
            json.mt +
            '" onclick="utils.DeleteNotifications(\'' +
            json.acId +
            "','" +
            json.id +
            '\')"><div style="width:50px; height:50px; float:left;"><img class="pull-left" src="' +
            base_url +
            '/images/profile_bg_40.png" alt="" /> </div>' +
            '<div style="float:right; width:250px"><p>' +
            json.message +
            '</p>' +
            '<p class="time">' +
            ' <span class="glyphicon glyphicon-time"></span>s ' +
            ' ' +
            time +
            ' ' +
            '</p></div>' +
          ...
          if (json.ut > v_li_array_list[0].attributes['data-time'].value) {
            ...
            v_li_array_list[0].outerHTML =
              v_content + v_li_array_list[0].outerHTML;
          } else if (
            json.ut <
            v_li_array_list[v_li_array_list.length - 1].attributes['data-time']
              .value
          ) {
            //------------------------------------ The new comer (notification) is the oldest, among all the notifications which are currently being displayed. ---------------------
            v_li_array_list[v_li_array_list.length - 1].outerHTML =
              v_li_array_list[v_li_array_list.length - 1].outerHTML + v_content;
          } else {
            ...
            while (true) {
              if (
                v_li_array_list[v_index].attributes['data-time'].value < json.ut
              ) {
                v_upper_index = v_index - 1;
                v_dif = v_upper_index - v_lower_index;
                if (v_dif <= 1) {
                  v_li_array_list[v_lower_index].outerHTML =
                    v_li_array_list[v_lower_index].outerHTML + v_content;
                  break;
                }
                v_index =
                  v_upper_index -
                  (v_dif % 2 == 0 ? v_dif / 2 : Math.ceil(v_dif / 2));
              } else if (
                v_li_array_list[v_index].attributes['data-time'].value > json.ut
              ) {
                ...
                v_li_array_list[v_index].attributes['data-time'].value ==
                json.ut
              ) {
                v_li_array_list[v_index].outerHTML =
                  v_content + v_li_array_list[v_index].outerHTML;
                break;
              }
            }
          }
      ...
      if (noti_counter > 0) {
        $('.notificationPanelin').attr(
          'from_index',
          parseInt(param_index) + noti_counter
        );
      }
      if ($('.notificationPanelin').attr('from_index') == 'NaN') {
        console.log($('.notificationPanelin').attr('from_index'));
      ...
      success: function (jsonData) {
        if (jsonData.sucs) {
          ...
          if (
            ...
            //profile (1 & 2) add friend/accept friend (3 & 4)
            window.location =
              base_url +
              '/secure/user/friend/profile.xhtml?friend=' +
              jsonData.fndId;
            ...
            window.location =
              base_url +
              '/secure/group/circle_home.xhtml?grpId=' +
              jsonData.acId;
          } else if (jsonData.mt == '6') {
            window.location =
              base_url +
              '/secure/user/newsfeed_comments.xhtml?activityId=' +
              activityId +
              '&ut=' +
              jsonData.ut +
              '&mt=' +
            ...
            window.location =
              base_url +
              '/secure/user/newsfeed_likes.xhtml?activityId=' +
              activityId +
              '&ut=' +
              jsonData.ut +
              '&mt=' +
  ...
  getStatusNotificationDetails: function (
    param_activityId,
    updateTime,
    messageType
  ) {
        ...
        if (messageType == '7') {
          if (json != null && json.sucs == true) {
            ...
            if (json.type == 1) {
              status_details_content +=
                ...
                utils.getProperImageUrl(v_img_list[0].iurl) +
                '" /></div></div>';
            }
          ...
          if (json != null && json.sucs == true) {
            ...
            if (json.type == 1) {
              status_details_content +=
                '<div class="thumbnail"><img src="' +
                utils.getProperImageUrl(json.iurl) +
                '" /></div></div>';
            }
            ...
            //8
            var cntnt =
              '<span class="glyphicon glyphicon-time"></span> ' + json.tm;
        ...
        if (jsonData.sucs) {
          ...
          for (var index = 0; index < jData.length; index++) {
            ...
            if (innerJson.deleted) {
              ...
              if (innerJson.frnS == '-1') {
                add_friend_content =
                  '<div class="pull-right"><img width="20" src="' +
                  base_url +
                  '/images/add_friend.png" onclick="javascript:friends.sendFriendRequest(\'' +
                  innerJson.uId +
                  '\',true)"/></div>';
              }
              ...
              content =
                '<li class="item ' +
                own_like_entry_class +
                '  cmntListUID' +
                innerJson.uId +
                '"><div class="pad_ten">' +
                '<a href="#" class="pull-left profile_img_bg_50">' +
                '<img width="50" height="50" alt="..." src="' +
                utils.getImageWithSize(
                  'thumb',
                  'http://38.108.92.154/auth/clients_image/' + innerJson.prIm
                ) +
                ...
                ' ' +
                innerJson.ln +
                '</a></h6></div><div class="clear"></div></div></li>';
          ...
          if (jsonData.alt_mg !== null) {
            ...
            if (junLikeData !== null) {
              ...
              if (!isFirstTime) {
                var prev_no_of_likes = $('#no_of_likes').text();
                $('#no_of_likes').text(
                  parseInt(prev_no_of_likes) - unLikeCounter
                ); //original code
              }
  ...
  getCommentsOnStatusDetails: function (
    nfId_property,
    uId,
    delAlwd,
    param_starting_index
  ) {
      ...
      success: function (jsonData) {
        ...
        if (jsonData.sucs) {
          ...
          for (var index = 0; index < jData.length; index++) {
            ...
            if (uId == innerJson.uID) {
              edit_delete_content =
                '<span class="caret"></span></a><ul aria-labelledby="dropdownMenu1" role="menu" class="dropdown-menu">' +
                '<li role="presentation"><a href="#" tabindex="-1" role="menuitem"  nfId="' +
                nfId_property +
                '" cmnId="' +
                commnetId +
                '"  class="edit_commnet">Edit</a></li>' +
                '<li role="presentation"><a href="#" tabindex="-1" role="menuitem"  nfId="' +
                nfId_property +
                '" cmnId="' +
                commnetId +
                '"  class="comment_delete_button" >Delete</a></li>' +
                '</ul>';
            } else if (delAlwd) {
              edit_delete_content =
                '<span class="caret"></span></a><ul aria-labelledby="dropdownMenu1" role="menu" class="dropdown-menu">' +
            ...
            content =
              ...
              '<li><a class="commnet_like_button " href="javascript:void(0)">' +
              like_unLike +
              '</a></li>' +
              '<li><a class="' +
              like_unLike_icon +
              ' jLikeCounter" data-toggle="modal" data-target="#likeModal" href="#">' +
              innerJson.nl +
              '</a></li></ul></li>';
          ...
          for (
            var index = 0;
            index < jEditOrDeleteCommentData.length;
            index++
          ) {
    ...
    setTimeout(function () {
      utils.getCommentsOnStatusDetails(
        nfId_property,
        uId,
        delAlwd,
        $('.comment-list').attr('index')
      );
    }, 15000);
  },
  ...
  replaceEmoticons: function (msg) {
    for (key in emoticons_map) {
      ...
      if (msg.toString().contains(key.toString())) {
        var imgTag =
          '<img class="emoticons" src="{PH}" alt="{AL}" title="{AL}" />';
        var simgTag =
          '<img class="emoticons" src="{PH}" alt="{AL}" title="{AL}" width=\'25\' height=\'25\' />';
        var placeHolder = '{PH}';
        var altHolder = '{AL}';
        if (obj.type === 0) {
          ...
          msg = msg.replace(
            key.toString(),
            simgTag.replace(placeHolder, obj.url)
          );
        } else if (obj.type === 1) {
          ...
          msg = msg.replace(
            key.toString(),
            imgTag.replace(placeHolder, obj.url)
          );
        }
      }
    }
      ...
      success: function (data, textStatus, jqXHR) {
        if (data != undefined && data != null) {
          if (data.sucs) {
            ...
            var frndId =
              param_friend_id == '-1' || typeof param_friend_id == 'undefined'
                ? userIdentity
                : param_friend_id;
            var i = 1;
            for (i = 1; i < jData.length; i++) {
              ...
              var link =
                '<a id="popim-' +
                jUnitData.id +
                '" data-toggle="lightbox" data-frnd="' +
                frndId +
                '" data-album="coverimage" data-gallery="' +
                frndId +
                'coverimage" class="album-popup-' +
                userIdentity +
                'coverimage" href="' +
                utils.getProperImageUrl(jUnitData.iurl) +
                '">';
              var content =
                link +
                '<img  src="' +
                ...
                '" height="90px" width="129px" id="cvImg' +
                +i +
                '"></a>';
              ...
              for (var j = i; j < 4; j++) {
                if (first) {
                  ...
                  var content =
                    '<img  src="' +
                    base_url +
                    '/images/default-cv.jpg" height="90px" width="129px" id="cvImg' +
                    +i +
                    '">';
                  ...
                  var content =
                    '<img  src="' +
                    base_url +
                    '/images/default-old-cov.jpg" height="90px" width="129px" id="cvImg' +
                    +i +
                    '">';
                  $('#cvImg' + +j).replaceWith(content);
                }
            ...
            if (img == 'none') {
              ...
              $('#coverImageDiv').css(
                'background-image',
                'url(' + base_url + '/images/default-cv.jpg)'
              );
              for (var i = 1; i < 4; i++) {
                var content =
                  '<img  src="' +
  ...
  composeMail: function () {
    var content =
      '<div class="modal fade" id="compose_mail_left" tabindex="-1" role="dialog" aria-labelledby="albumModal_circleLabel" aria-hidden="true">' +
  ...
  getOriginalImageUrl: function (param_marker, param_url) {
    ...
    var v_original_url =
      param_url.substring(0, index) +
      '/' +
      param_url.substring(index + param_marker.length, param_url.length);
  ...
  getImageUploadInfo: function () {
    ...
    if (
      ...
      console.log(
        '--------------------------- Image Upload Info servlet called ---------------------------'
      );
      $.ajax({
        type: 'POST',
