      ...
      ChatResponseProcessor, ChatSeenSend, ChatHelper, ChatConnector) {
        ...
        function processUpdates(responseObject) {
            ...
            if( !packetProcessorInfo ){
                RingLogger.warning('M: Packet Processor Not Implemented. Packet Type ', packetType, 'CHAT');
                return false;
            }
            ...
            try{
               ...
               RingLogger.alert('M: Exception In PACKET Procsessing.', packetType, e , RingLogger.tags.CHAT);
            }
        ...
        for(var index = 0; index < messages.length; index++){
          ...
          //boxIds[anUnreadMessage.userId] = true;
            ...
            //}else{
             ...
             // RingLogger.alert('Unread Deleted Message', anUnreadMessage, 'CHAT');
           // }
        }
