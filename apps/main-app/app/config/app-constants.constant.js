...
angular
  ...
  .constant('SystemEvents', {
    ...
    PORTAL: {
      DONE_FOLLOW_PORTAL: 'DONE_FOLLOW_PORTAL',
      UNFOLLOW_PORTAL: 'UNFOLLOW_PORTAL',
    },
    ...
    CIRCLE: {
      ...
      MY_CIRCLE_MEMBER_LIST_FETCH_COMPLETE:
        'MY_CIRCLE_MEMBER_LIST_FETCH_COMPLETE',
      MY_CIRCLE_MEMBER_LIST_PROCESS_COMPLETE:
        'MY_CIRCLE_MEMBER_LIST_PROCESS_COMPLETE',

      MY_CIRCLE_MEMBER_LIST_UPDATE_COMPLETE:
        'MY_CIRCLE_MEMBER_LIST_UPDATE_COMPLETE',
    ...
    FRIEND: {
      PENDING_FRIENDS_COUNT_CHANGED: 'PENDING_FRIENDS_COUNT_CHANGED',
    ...
    CHAT: {
      ...
      SINGLE_MESSAGE_TIMEOUT: 'SINGLE_MESSAGE_TIMEOUT',
      ...
      TAG_MEMBER_FETCHED: 'TAG_MEMBER_FETCHED',
      ...
      //Conversation Count
      CONVERSATION_COUNT_RESETED: 'CONVERSATION_COUNT_RESETED',
    },
  })
  .constant('MESSAGES', {
    ...
    RC60: 'Friend limit over!', // "FRIEND_LIMIT_OVER",
    RC64: 'Pending friend limit over!', // "PENDING_FRIEND_LIMIT_OVER",
    RC65: "Friend's pending friend limit over", // "FRIENDS_PENDING_FRIEND_LIMIT_OVER",
    RC66: "Friend's friend limit over", // "FRIENDS_FRIEND_LIMIT_OVER",

    RC404: 'NOT_FOUND', // reason code 404
    CRCFS1: "Wall post can't be shared", //custom reason code feed share wall post
    CRCFS2: "Group post can't be shared", //custom reason code feed share group post
    CRCFS3: 'You already shared this post', //custom reason code feed already shared post
    FEED_INV: 'Please insert some text or upload an image!',
    FTL_ERROR:
      "A status can't be longer than {max_limit} characters, but this one is {length} characters long. Please make it a little shorter and try again.", // feed text limit error
    FEED: {
    ...
    NEWSPORTAL: {
      C_UNFOLLOW: 'Are you sure you want to unfollow?',
    },
  })
  ...
  .constant('PrivacySet', {
    PVC1: {
      icon: 'img_sprite post-ico only-i',
      iconfeed: 'img_sprite post-ico-gray only-i',
      text: 'Only me',
      value: 1,
    },
    PVC2: {
      icon: 'img_sprite post-ico fri-i',
      iconfeed: 'post-ico-gray fri-i',
      text: 'Friends',
      value: 2,
    },
    PVC3: {
      icon: 'img_sprite post-ico pub-i',
      iconfeed: 'img_sprite post-ico-gray pub-i',
      text: 'Public',
      value: 3,
    },
  })
