...
var settings = {
  ...
  constantServer:
    'http://auth.ringid.com/cnstnts?pf=5&v=' +
    setting_default.apiVersion +
    '&apt=1',
  socketProtocol: 'ws://',
  ...
  stickerApi:
    setting_default.stmapi +
    'ringmarket/StickerHandler/?pf=5&v=' +
    setting_default.apiVersion +
    '&',
...
function setUrlBase(ob) {
  ...
  settings.signupSocialInit =
    ob.ac + 'comports?pf=5&v=' + settings.apiVersion + '&'; // append platform = twtr/fb id and lt=4/5
  ...
  settings.stickerApi =
    ...
    'ringmarket/StickerHandler/?pf=5&v=' +
    settings.apiVersion +
    '&'; // protocol+'image.ringid.com/ringmarket/StickerHandler/',
}
